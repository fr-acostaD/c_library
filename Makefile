...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/09/23 20:16:14 by facosta-          #+#    #+#              #
#    Updated: 2024/09/25 13:19:49 by facosta-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strjoin.c ft_strtrim.c ft_strmapi.c ft_itoa.c ft_split.c ft_isupper.c\
ft_islower.c ft_pow.c ft_intlen.c ft_striteri.c
